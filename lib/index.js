...
class Chessboard {
    constructor(options) {
        ...
        this.theme = types_1.Theme.Modern;
        this.flipped = false;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let r = 0; r < 8; r++) {
                for (let c = 0; c < 8; c++) {
                    ...
                    if (piece) {
                        const image = yield (0, canvas_1.loadImage)(path_1.default.join(__dirname, `../public/${this.theme}/${piece.color}${piece.type}.png`));
